...
const Sidebar: React.FC<SidebarProps> = ({ 
  ...
  return (
    <div className={sidebarClasses}>
      ...
      {/* View Modes */}
      <div className="mb-6">
        <h3 className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-3">CHART TYPE</h3>
      ...
      {/* Data Source */}
      <div className="mb-6">
        <h3 className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-3">UPLOAD DATA</h3>
                ...
                {isProcessing ? (
                    ...
                    <>
                        ...
                        <span className={`text-xs font-medium ${errorMsg ? 'text-red-600' : ''}`}>
                            {errorMsg ? 'Import Failed' : (isDragging ? 'Drag & drop file here' : 'Click to upload')}
                        </span>
                        <span className="text-[10px] text-gray-400 mt-1">{errorMsg ? 'Click to retry' : 'Supports Excel or CSV'}</span>
                    </>
                )}
            </div>
        </div>
      ...
      <div className="flex-1 overflow-y-auto min-h-0">
        <div className="flex items-center justify-between mb-3">
            <h3 className="text-xs font-semibold text-gray-500 uppercase tracking-wider">ACTIVE SERIES</h3>
